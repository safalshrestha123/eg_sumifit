  ...
  return (
    <main className="grid min-h-screen bg-white dark:bg-gray-950 lg:grid-cols-[1.05fr_0.95fr]">
      <section className="relative hidden overflow-hidden bg-gray-950 p-12 text-white lg:flex lg:flex-col lg:justify-between xl:p-20">
        ...
        <div className="relative flex items-center gap-3 text-sm text-gray-400"><ShieldCheck className="size-5 text-emerald-400" /> Frontend demonstration · mock data only</div>
      </section>
      <section className="flex items-center justify-center px-5 py-12 sm:px-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-orange-600">Admin access</p><h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">Welcome back, Sumi.</h2><p className="mt-3 text-sm leading-6 text-gray-500">Use the demo credentials below to preview the content workspace.</p>
          <LoginForm />
        </div>
      </section>
    </main>
